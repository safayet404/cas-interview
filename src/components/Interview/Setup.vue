...
import { Check, CheckCircle2, ChevronDown, Mic, MicOff, MoreVertical, Router, Video } from 'lucide-vue-next';
...
<template>
    <div class="grid grid-cols-4 h-screen overflow-hidden bg-white">
        ...
        <div class="col-span-1 bg-white p-12 flex flex-col justify-between border-r border-slate-100">
            ...
            <RouterLink to="/questions" :disabled="setupStatus.camera !== 'ready'"
